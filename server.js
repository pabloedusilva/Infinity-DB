...
// Rotas do sistema de backup (apenas para admin)
app.use('/api/backup', backupRoutes);

// Rotas de teste do sistema de backup (sem autenticação para debugging)
const backupTestRoutes = require('./backup-system/api-routes-test');
app.use('/api/backup-test', backupTestRoutes);
...
// Rota para servir o dashboard widget do backup diretamente
app.get('/backup-system/dashboard-widget.html', (req, res) => {
    res.sendFile(path.join(__dirname, 'backup-system', 'dashboard-widget.html'));
});

// Servir arquivos estáticos do sistema de backup
app.use('/backup-system', express.static(path.join(__dirname, 'backup-system')));
